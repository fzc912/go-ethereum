...
func (_Migrator *MigratorTransactor) Migrate(opts *bind.TransactOpts, token common.Address, amountTokenMin *big.Int, amountETHMin *big.Int, to common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Migrator.contract.Transact(opts, "migrate", token, amountTokenMin, amountETHMin, to, deadline)
}

// Migrate is a paid mutator transaction binding the contract method 0xb7df1d25.
//
// Solidity: function migrate(address token, uint256 amountTokenMin, uint256 amountETHMin, address to, uint256 deadline) returns()
func (_Migrator *MigratorSession) Migrate(token common.Address, amountTokenMin *big.Int, amountETHMin *big.Int, to common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Migrator.Contract.Migrate(&_Migrator.TransactOpts, token, amountTokenMin, amountETHMin, to, deadline)
}

// Migrate is a paid mutator transaction binding the contract method 0xb7df1d25.
//
// Solidity: function migrate(address token, uint256 amountTokenMin, uint256 amountETHMin, address to, uint256 deadline) returns()
func (_Migrator *MigratorTransactorSession) Migrate(token common.Address, amountTokenMin *big.Int, amountETHMin *big.Int, to common.Address, deadline *big.Int) (*types.Transaction, error) {
	return _Migrator.Contract.Migrate(&_Migrator.TransactOpts, token, amountTokenMin, amountETHMin, to, deadline)
}
